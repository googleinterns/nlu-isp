...
class Vocabulary(object):
    ...
    def __init__(self, name: str, special_tokens: List=None):
        """Initialization.

        :name: name of the vocabulary
        :special_tokens: speical tokens to be added to vocabulary, including tokens that are generally used for masking, e.g.:
                         - [CLS], [SEP], [MASK]: for BERT
                         - [PAD]: for padding
                         - [UNK]: for OOV tokens
                         - <BOS>, <EOS>: beginning-of-sentence, end-of-sentence indicators
        """
        ...
        if special_tokens:
            self.add_instance(special_tokens)
